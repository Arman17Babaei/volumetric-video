...
/*
 * Default PI2 parameters from RFC 9332 Appendix A, represented for BMv2:
 *
...
const int<32> DEFAULT_TARGET_US        = 15000;
...
const int<32> DEFAULT_L4S_MIN_US       = 800;
const int<32> DEFAULT_L4S_RANGE_US     = 400;
/* floor(0xFFFFFFFF / 400), in Q0.32 probability units per us */
const bit<32> DEFAULT_L4S_SLOPE_Q32_PER_US = 32w10737418;
const bit<19> DEFAULT_L4S_MIN_QUEUE_PKTS   = 19w1;
